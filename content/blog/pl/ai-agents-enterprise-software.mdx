...
export const schemas = [
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Czym są agenty AI?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Agenty AI to autonomiczne systemy oprogramowania, które potrafią samodzielnie rozumować, planować i wykonywać złożone zadania — to znacznie więcej niż proste chatboty.",
        },
      },
      {
        "@type": "Question",
        name: "Jakie korporacyjne zastosowania mają agenty AI?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Obsługa klienta (zapytania, zwroty), sprzedaż (kwalifikacja leadów, aktualizacja CRM), analiza danych (wzorce, raporty), łańcuch dostaw (prognozowanie, zapasy).",
        },
      },
      {
        "@type": "Question",
        name: "Jak zacząć pracę z agentami AI?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Zidentyfikuj zastosowania o wysokiej wartości, zacznij od małych pilotaży, mierz wyniki i iteruj na podstawie feedbacku.",
        },
      },
    ],
  },
  {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "Budowanie Skutecznych Agentów AI",
    step: [
      {
        "@type": "HowToStep",
        name: "Zdefiniuj Jasne Granice",
        text: "Ustal, co agent może, a czego nie, np. maksymalne kwoty zwrotów.",
      },
      {
        "@type": "HowToStep",
        name: "Zadbaj o Obserwowalność",
        text: "Loguj wszystkie decyzje na potrzeby debugowania, zgodności i ulepszeń.",
      },
      {
        "@type": "HowToStep",
        name: "Zaprojektuj Kontrolowaną Degradację",
        text: "Eskaluj w razie niepewności.",
      },
      {
        "@type": "HowToStep",
        name: "Wdróż Human-in-the-Loop",
        text: "Wymagaj zatwierdzenia dla krytycznych decyzji.",
      },
    ],
  },
  {
