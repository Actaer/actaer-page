      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="cta-content max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let&apos;s discuss how we can help you solve your most demanding
            challenges with smart technology solutions.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button asChild variant="outline" size="lg">
              <Link href="/products/vantum-erp">Explore Vantum ERP</Link>
            </Button>
          </div>
        </div>
      </div>
